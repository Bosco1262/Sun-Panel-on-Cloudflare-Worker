...
> - 本仓库移植版说明：[根 README.zh-CN](../../README.zh-CN.md)
> - 上游更新日志：[CHANGELOG.zh-CN.md](./CHANGELOG.zh-CN.md)（仅存档到 v1.1.0，v1.2.0 起见上游文档站的「正式版更新日志」）
>
> 说明：原文中的「Donate」段落因相关图片（`doc/donate.md`、`doc/images/donate/*.png`）未随本仓库同步，已移除；
> 图片路径已改指向本仓库的 [`../assets/`](../assets/)；上游文档站已从 `sun-panel-doc.enianteam.com`
